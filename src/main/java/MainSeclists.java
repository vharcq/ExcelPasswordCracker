...
public class MainSeclists {
    ...
    public static String crackPassword(File inputFile) {
        ...
        Runnable producer = passwordProvider(passwordQueue, "passwords.txt");
...
private static Runnable passwordProvider(BlockingQueue<String> passwordQueue, String path) {
    return () -> {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = br.readLine()) != null && !Thread.currentThread().isInterrupted()) {
                ...
                try {
                    passwordQueue.offer(line.trim(), 12, TimeUnit.HOURS);
